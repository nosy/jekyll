...
* "安装":http://wiki.github.com/mojombo/jekyll/install the gem
* "使用":http://wiki.github.com/mojombo/jekyll/usage and "配置":http://wiki.github.com/mojombo/jekyll/configuration
* 看一看现有的"站点":http://wiki.github.com/mojombo/jekyll/sites
* 分支 和 "贡献":http://wiki.github.com/mojombo/jekyll/contribute your own modifications
